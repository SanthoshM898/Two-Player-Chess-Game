...
function ClickedSquare(pageX, pageY) {
	...
	var file = Math.floor((pageX-workedX) / 90);
	var rank = 7 - Math.floor((pageY-workedY) / 90);
...
function RemoveGUIPiece(sq) {
	...
	$( ".Piece" ).each(function( index ) {
		 ...
		 if( (RanksBrd[sq] == 7 - Math.round($(this).position().top/90)) && (FilesBrd[sq] == Math.round($(this).position().left/90)) ){		
		 	//console.log( "Picture:" + index + ": " + $(this).position().top + "," + $(this).position().left );	
			$(this).remove();			
		 }
		});
...
function MoveGUIPiece(move) {
	...
	$( ".Piece" ).each(function( index ) {
     //console.log( "Picture:" + index + ": " + $(this).position().top + "," + $(this).position().left );
     if( (RanksBrd[flippedFrom] == 7 - Math.round($(this).position().top/90)) && (FilesBrd[flippedFrom] == Math.round($(this).position().left/90)) ){
...
function SetSqSelected(sq) {
	...
	$( ".Square" ).each(function( index ) {    
	//console.log("Looking Sq Selected RanksBrd[sq] " + RanksBrd[sq] + " FilesBrd[sq] " + FilesBrd[sq] + " position " + Math.round($(this).position().left/90) + "," + Math.round($(this).position().top/90));	
     if( (RanksBrd[sq] == 7 - Math.round($(this).position().top/90)) && (FilesBrd[sq] == Math.round($(this).position().left/90)) ){   
